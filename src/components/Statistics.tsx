  ...
  return (
    <div className="p-2 max-w-sm mx-auto" id="statistics-section">
      ...
      <div className="space-y-2">
        ...
        <div className="bg-white rounded-none p-3 border border-[#1A1A1A]/10 shadow-[3px_3px_0px_rgba(26,26,26,0.02)]">
          <h3 className="text-[8px] font-bold text-[#1A1A1A]/40 font-serif tracking-widest mb-2.5 uppercase text-left">
            制覇の進捗
          </h3>
          ...
          <div className="flex flex-row items-center gap-4 justify-around">
            ...
            <div className="relative w-20 h-20 flex items-center justify-center shrink-0">
              ...
              <div className="absolute flex flex-col items-center justify-center text-center">
                ...
                <span className="text-[7px] text-[#1A1A1A]/40 font-bold tracking-widest uppercase font-serif mt-0.5">Master</span>
              </div>
            </div>
            ...
            <div className="space-y-2 w-full max-w-[160px] font-serif">
              <div>
                ...
                <div className="w-full h-1.5 bg-[#F3F0E9] rounded-none overflow-hidden">
        ...
        {/* クイズ回答統計のサマリー */}
        <div className="bg-white rounded-none p-3 border border-[#1A1A1A]/10 shadow-[3px_3px_0px_rgba(26,26,26,0.02)]">
          <h3 className="text-[8px] font-bold text-[#1A1A1A]/40 font-serif tracking-widest mb-2 uppercase text-left">
            総合データ
          </h3>

          <div className="grid grid-cols-3 gap-1.5 text-center">
            <div className="bg-[#F3F0E9] p-2 rounded-none border border-[#1A1A1A]/5">
              <span className="text-[8px] font-bold text-[#1A1A1A]/40 block mb-0.5 font-serif uppercase tracking-wider">回答数</span>
              <span className="text-base font-bold font-serif text-[#1A1A1A]">
                {userStats.correctAnswersCount + userStats.wrongAnswersCount} <span className="text-[9px] text-[#1A1A1A]/40 font-normal">回</span>
              </span>
            </div>
            <div className="bg-[#2E6F40]/5 p-2 rounded-none border border-[#2E6F40]/15">
              ...
              <span className="text-base font-bold font-serif text-[#2E6F40]">
                {userStats.correctAnswersCount} <span className="text-[9px] text-[#2E6F40]/60 font-normal">回</span>
              </span>
            </div>
            <div className="bg-[#F3F0E9] p-2 rounded-none border border-[#1A1A1A]/5">
              <span className="text-[8px] font-bold text-[#1A1A1A]/40 block mb-0.5 font-serif uppercase tracking-wider">正答率</span>
        ...
        <div className="bg-white rounded-none p-3 border border-[#1A1A1A]/10 shadow-[3px_3px_0px_rgba(26,26,26,0.02)]">
            ...
            {typeStats.map((item) => (
              <div key={item.key} className="space-y-0.5">
                <div className="flex justify-between items-center text-[9px] font-bold">
                  <span className="text-[#1A1A1A]/80 font-serif flex items-center gap-1">
                    <span className="w-1 h-1 bg-[#D44D26]"></span>
                    {item.label}
                  </span>
                  <span className="text-[#1A1A1A]/50 font-serif">
                    {item.total > 0 ? `${item.accuracy}% (${item.correct}/${item.total})` : '未挑戦'}
                  </span>
                </div>
                <div className="w-full h-1 bg-[#F3F0E9] rounded-none overflow-hidden">
                  <motion.div 
                    initial={{ width: 0 }}
          ...
          <p className="text-[8px] text-[#1A1A1A]/50 mt-2 leading-relaxed flex items-start gap-1 font-serif text-left">
        ...
        <div className="pt-1 flex justify-center">
          <button
            onClick={onReset}
            className="flex items-center gap-1 py-1.5 px-3 border border-[#D44D26]/30 hover:bg-[#D44D26]/5 text-[#D44D26] text-[9px] font-bold uppercase tracking-widest rounded-none transition-all font-serif cursor-pointer"
            id="btn-reset-stats"
          >
            学習データを初期化する
          </button>
